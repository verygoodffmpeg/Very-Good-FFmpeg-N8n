...
Run [FFmpeg](https://ffmpeg.org) jobs in the cloud from your [n8n](https://n8n.io) workflows, using the [Very Good FFmpeg](https://verygoodffmpeg.com) API. Transcode, trim, resize, and convert video and audio without hosting FFmpeg yourself, on CPU or NVIDIA GPU machines.
